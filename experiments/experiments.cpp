...
#define STANDARD_BAR_LEN 60
    ...
    */
    ...
    /**
     * Creates columns in the output file
    */
    ...
    /**
     * Runs given algorithm on the batch of graphs
    */
                    ...
                    const SaveParams& save_params)
    {
        ...
        for (auto& graph : batch) {
            ...
            // output graph processing results
            {
                if (save_params.make_tables)
    ...
    /**
     * Runs given algorithm on the pool of data
    */
    ...
    /**
     * Check stability of algorithm on the graph pool
    */
    ...
    /**
     * Writes the data into the output directory
    */
