...
\large
 ...
 На рисунке~\ref{fig:scal1} видно, что уже на 14-16 вершинах при малом P ЛП работает близко к 1000 секундам, а начиная с 17 вершин и вовсе не завершается. На рисунке~\ref{fig:scal4} же видно, что при большом P ЛП завершается на графах вплоть до 20 вершин, при этом часто оказываясь значительно лучше обоих ЖА по длительности и ни разу им не уступая.
...
\begin{center}
	\includegraphics[width=1.01\textwidth]{pictures/greedy_EFT_layered_12_1_lp2_2_321.png}
	\captionof{figure}{}
	\label{fig:EFT_12}
\end{center}
