...
Основы линейного программирования содержатся в работе~\cite{ShevchenkoZolotykh2004}. За основу также бралось сведение однопроцессорного варианта задачи к ЦЛП из работы~\cite{Senyushkina2025}.
...
Минимизировать $l$ при ограничениях \eqref{eq:m_ge_frac}--\eqref{eq:l_bound}.  
