...
Основы линейного программирования содержатся в статье~\cite{ShevchenkoZolotykh2004}. Также за основу бралось сведение однопроцессорного варианта задачи к ЦЛП из работы~\cite{ShevchenkoZolotykh2004}.
...
Минимизировать \( l \) при ограничениях 
\eqref{eq:m_diag}--\eqref{eq:m_le}, 
\eqref{eq:p_sum}, 
\eqref{eq:t_ge}--\eqref{eq:t_le}, 
\eqref{eq:prec}, 
\eqref{eq:start_def}, 
\eqref{eq:max_end_def}, 
\eqref{eq:no_conflict1}--\eqref{eq:no_conflict2}, 
\eqref{eq:z_start}--\eqref{eq:aa_end}, 
\eqref{eq:mem_start}--\eqref{eq:mem_end}, 
\eqref{eq:l_bound};
